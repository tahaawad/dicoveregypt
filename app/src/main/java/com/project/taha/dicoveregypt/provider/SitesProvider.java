...
public class SitesProvider  extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.project.taha.dicoveregypt";
    ...
    public static final String MIME_TYPE_1 = ContentResolver.CURSOR_DIR_BASE_TYPE+"/"+"vnd.com.taha.sites";
    public static final String MIME_TYPE_2 = ContentResolver.CURSOR_DIR_BASE_TYPE+"/"+"vnd.com.taha.siteid";
